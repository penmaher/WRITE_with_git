...
echo 'Removing -> ' $AUTHORCOLORS
rm -rf $AUTHORCOLORS
echo 'Removing -> ' $AUTHORINFO
rm -rf $AUTHORINFO
echo 'Removing -> ' $COLORCHANGE
rm -rf $COLORCHANGE

if [ ! -e $MYAUTHORCOLORS ]
then
  echo 'Creating -> ' $AUTHORCOLORS
